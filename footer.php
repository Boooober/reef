...
<script type="text/javascript" src="<?php echo $templateurl ?>/assets/js/jquery.backgroundvideo.min.js"></script>


<!--<script src="http://cdnjs.cloudflare.com/ajax/libs/jquery.transit/0.9.9/jquery.transit.min.js"></script>-->
<!--<script type="text/javascript" src="--><?php //echo $templateurl ?><!--/assets/plugins/owl.carousel/owl.carousel.min.js"></script>-->
    <div id="copy-witty">
        <div>
